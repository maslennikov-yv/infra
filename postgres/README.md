...
```bash
make view-backup BACKUP_FILE=backups/stage/postgres-backup-20231103.sql.gz
make view-backup-head BACKUP_FILE=backups/stage/postgres-backup-20231103.sql.gz
make view-backup-search BACKUP_FILE=backups/stage/postgres-backup-20231103.sql.gz SEARCH='CREATE TABLE'
make list-backups
```
...
# Или из postgres/
make restore BACKUP_FILE=backups/stage/postgres-backup-20231103.sql.gz ENV=stage
make restore-single BACKUP_FILE=backups/stage/app_db-backup-20231103.sql.gz DB_NAME=app_db ENV=stage
```
